    ...
    def _calculate_q_vals(self, rewards: Sequence[np.ndarray]) -> Sequence[np.ndarray]:
        ...
        if not self.use_reward_to_go:
            ...
            for traj_rewards in rewards:
                traj_q_vals = self._discounted_return(traj_rewards.tolist())
                q_values.append(np.array(traj_q_vals))
        else:
            ...
            q_values = []
            for traj_rewards in rewards:
                traj_q_vals = self._discounted_reward_to_go(traj_rewards.tolist())
                q_values.append(np.array(traj_q_vals))
